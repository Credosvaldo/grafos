...
class TestAllGraphDirected(unittest.TestCase):
    ...
    def test_add_edge(self):
        ...
        self.assertEqual(self.graphMA.edges_map["edge1"], ("A", "B", 0)) # 0 is the index of the edge

        self.graphMI.add_node("A", 1.0)
        self.graphMI.add_node("B", 2.0)
        self.graphMI.add_edge("A", "B", 3.0, "edge1")
        self.assertIn("edge1", self.graphMI.edges_map)
        self.assertEqual(self.graphMI.edges_map["edge1"], ("A", "B", 0, 3.0)) # 0 is the index of the edgecl
    ...
    def test_thers_node_adjacency(self):
        ...
        self.graphMA.add_node("B", 2.0)
        self.graphMA.add_edge("A", "B", 3.0, "edge1")
        self.assertTrue(self.graphMA.thers_node_adjacente("A", "B"))
        self.assertFalse(self.graphMA.thers_node_adjacente("B", "A"))
    ...
    def test_get_euler_path(self):
        ...
        self.graphLA.add_node("B", 2.0)
        self.graphLA.add_edge("A", "B", 3.0, "edge1")
        self.assertEqual(self.graphLA.get_euler_path(), [])

        self.graphMA.add_node("A", 1.0)
        self.graphMA.add_node("B", 2.0)
        self.graphMA.add_edge("A", "B", 3.0, "edge1")
        self.assertEqual(self.graphMA.get_euler_path(), [])

        self.graphMI.add_node("A", 1.0)
        self.graphMI.add_node("B", 2.0)
        self.graphMI.add_edge("A", "B", 3.0, "edge1")
        self.assertEqual(self.graphMI.get_euler_path(), [])
    ...
    def test_get_all_nodes_degree(self):
        ...
        self.graphLA.add_node("B", 2.0)
        self.graphLA.add_edge("A", "B", 3.0, "edge1")
        self.assertEqual(self.graphLA.get_all_nodes_degree(), {"A": 1, "B": 1})

        self.graphMA.add_node("A", 1.0)
        self.graphMA.add_node("B", 2.0)
        self.graphMA.add_edge("A", "B", 3.0, "edge1")
        self.assertEqual(self.graphMA.get_all_nodes_degree(), {"A": 1, "B": 1})

        self.graphMI.add_node("A", 1.0)
        self.graphMI.add_node("B", 2.0)
        self.graphMI.add_edge("A", "B", 3.0, "edge1")
        self.assertEqual(self.graphMI.get_all_nodes_degree(), {"A": 1, "B": 1})
