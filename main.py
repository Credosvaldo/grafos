...
print(b.theres_edge_adjacente("e1", "e2"))
b.add_edge("B", "1", 1.0, "edge3")
print(b.theres_edge_adjacente("edge3", "e2"))
print(b.theres_edge_adjacente("edge3", "e1"))
print(b.thers_edge_by_name("edge3"))
print(b.thers_edge_by_name("edge1"))
print(b.thers_edge_by_name("edge4"))
